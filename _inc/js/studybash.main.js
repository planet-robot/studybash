                ...
                if ( userError ) {
                    switch ( userError.type ) {
                        case "institution":
                            this.onAttrsInvalid({
                                field:"email",
                                msg:"<strong>Email</strong>: I'm sorry but we only support the following institutions at the moment: <em>" + userError.msg + "</em>. Please <a href='mailto:help@studybash.com'>email us</a> if you want your institution added to our list."
                            });
                            break;
                        case "full":
