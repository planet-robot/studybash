...
<div class="navbar navbar-default">
	...
	<div class="navbar-collapse collapse">
		...
		<ul class="nav navbar-nav">			
			<li class="active"><a href="<?php echo Bootstrap::get_setting('php_root');?>sysop/errors/">Errors</a></li>
			<li><a href="<?php echo Bootstrap::get_setting('php_root');?>sysop/activity/">Activity</a></li>
