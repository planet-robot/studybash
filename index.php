...
<body>
	...
	<script src='<?php echo $jsRoot;?>_plugins/jquery.types/jquery.types.min.js'></script>
	<script src='<?php echo $jsRoot;?>_plugins/jquery.includejs/jquery.includejs.min.js'></script>	
	<script src='<?php echo $jsRoot;?>_plugins/browser_support/jquery.browser_support.min.js'></script>
	<script src='<?php echo $jsRoot;?>_plugins/jquery.storage/jquery.storage.min.js'></script>
	<script src='<?php echo $jsRoot;?>_plugins/serialize_object/jquery.serialize_object.min.js'></script>	
	<script src='<?php echo $jsRoot;?>_plugins/jquery.traced_error/jquery.traced_error.min.js'></script>
	<script src='<?php echo $jsRoot;?>_plugins/leftovers/jquery.leftovers.min.js'></script>
	...
	<script src='<?php echo $jsRoot;?>_inc/js/studybash.base.min.js'></script>
	<script src='<?php echo $jsRoot;?>_inc/js/studybash.main.min.js'></script>
